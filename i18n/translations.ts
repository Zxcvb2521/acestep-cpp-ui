...
export const translations = {
  ...
  ru: {
    ...
    // Username Modal
    welcomeTitle: 'Добро пожаловать в ACE-Step UI',
    welcomeSubtitle: 'Введите ваше имя, чтобы начать создавать музыку с ИИ',
    yourName: 'Ваше имя',
    enterYourName: 'Введите ваше имя',
    getStarted: 'Начать',
    gettingStarted: 'Загрузка...',
    yourMusicYourWay: 'Ваша музыка — ваши правила. Создавайте неограниченное количество треков бесплатно.',
    usernameMinLength: 'Имя пользователя должно содержать не менее 2 символов',
    usernameInvalidChars: 'Имя пользователя может содержать только буквы, цифры, нижние подчёркивания и дефисы',
    failedToSetUsername: 'Не удалось задать имя пользователя',

    // Toasts
    songNotAvailable: 'Этот трек больше недоступен.',
    unableToPlay: 'Не удалось воспроизвести трек.',
    ...
    songAddedToPlaylist: 'Трек добавлен в плейлист',
    failedToAddSong: 'Не удалось добавить трек в плейлист',
    songDeleted: 'Трек успешно удалён',
    failedToDeleteSong: 'Не удалось удалить трек',
    ...
    about: 'О программе',
    version: 'Версия',
    localAIMusicGenerator: 'Локальный ИИ-генератор музыки',
    poweredBy: 'Основано на ACE-Step 1.5. Открытый исходный код, бесплатно.',
    createdBy: 'Создано Ambsd',
    ...
    loraScale: 'Сила LoRA',
    loraScaleDescription: 'Настройте силу влияния модели LoRA',
    ...
    leaveLyricsEmpty: 'Оставьте пустым для инструментала или переключите ниже',
    vocal: 'Вокал',
    ...
    vocalChineseMandarin: 'Китайский (мандаринский)',

    // CreatePanel - Style
    stylePlaceholder: 'например: весёлый поп-рок, эмоциональная баллада, хип-хоп 90-х',
    ...
    inferenceSteps: 'Шагов генерации',
    guidanceScale: 'Сила направления',
    inferMethod: 'Метод генерации',
    shift: 'Смещение',
    timestepShiftForBase: 'Смещение шага для базовых моделей (не влияет на turbo)',
    ...
    controlSourceAudio: 'Управляет степенью следования модели исходному аудио',
    audioCodes: 'Аудиокоды',
    optionalAudioCodes: 'Дополнительная нагрузка аудиокодов',
    taskType: 'Тип задачи',
    textToMusic: 'Текст → Музыка',
    audioCoverStrength: 'Сила кавера',
    repaintingStart: 'Начало перерисовки',
    repaintingEnd: 'Конец перерисовки',
    instruction: 'Инструкция',
    lmTemperature: 'Температура LM',
    higherMoreRandom: 'Выше = больше случайности (0–2)',
    lmCfgScale: 'CFG Scale LM',
    ...
    useWhenCfgScaleGreater: 'Используйте при LM CFG Scale > 1.0',
    lmTopK: 'LM Top-K',
    lmTopP: 'LM Top-P',

    // Guidance section
    guidance: 'НАПРАВЛЕНИЕ',
    advancedCfgScheduling: 'Расширенные настройки CFG-расписания.',
    cfgIntervalStart: 'Начало интервала CFG',
    cfgIntervalEnd: 'Конец интервала CFG',
    customTimesteps: 'Пользовательские шаги',
    timestepsPlaceholder: 'например: 1,3,5,7',
    scoreScale: 'Score Scale',
    lmBatchChunkSize: 'Размер блока LM Batch',
    trackName: 'Название трека',
    optionalTrackName: 'Необязательное название трека',
    completeTrackClasses: 'Классы полного трека',
    trackClassesPlaceholder: 'class-a, class-b',
    useAdg: 'Использовать ADG',
    allowLmBatch: 'Разрешить LM Batch',
    useCotMetas: 'Использовать CoT Metas',
    useCotCaption: 'Использовать CoT Caption',
    useCotLanguage: 'Использовать CoT Language',
    ...
    job: 'задача',
    jobs: 'задачи',
    queueMultipleJobs: 'Поставить в очередь несколько независимых задач с одинаковыми настройками',
    numberOfVariations: 'Количество вариаций трека для генерации',
    moreStepsBetterQuality: 'Больше шагов = лучше качество, медленнее (8 рекомендуется для turbo)',
    howCloselyFollowPrompt: 'Насколько точно следовать промпту',
    seed: 'Сид',
    randomSeedRecommended: 'Случайный при каждом запуске (рекомендуется)',
    fixedSeedReproducible: 'Фиксированный сид для воспроизводимых результатов',
    enterFixedSeed: 'Введите фиксированный сид',
    enhance: 'ИИ-улучшение',
    enhanceHint: 'лучшая точность жанра, немного медленнее',
    enhanceTooltip: 'Использует языковую модель для обогащения тегов жанра/стиля до детального музыкального описания и генерации BPM, тональности и размера. Улучшает точность жанра, но добавляет 10–20 с к времени генерации. Дополнительная VRAM не нужна.',
    thinkingCot: 'Размышление (CoT)',
    mp3Smaller: 'MP3 (меньший размер)',
    ...
    lmModel06B: '0.6B (Лёгкая, ~0.5 ГБ VRAM)',
    lmModel17B: '1.7B (Сбалансированная, ~1.5 ГБ VRAM)',
    lmModel4B: '4B (Лучшее качество, ~4 ГБ VRAM)',
    lmModelHint: 'Управляет LLM для генерации текста/стиля. Скачивается автоматически при отсутствии.',

    // CreatePanel - Transcription
    transcribing: 'Транскрибирование...',
    transcribingWithWhisper: 'Транскрибирование с Whisper…',

    // CreatePanel - Library Tabs
    uploaded: 'Загруженные',
    createdTab: 'Созданные',
    useTrack: 'Использовать',
    noCreatedSongsYet: 'Созданных треков пока нет',
    generateSongsToReuse: 'Генерируйте треки, чтобы использовать их как кавер или референс',
    ...
    // Simple Mode
    describeYourSong: 'ОПИШИТЕ ВАШ ТРЕК',
    ...
    formatFailedDetail: 'Ошибка форматирования. Убедитесь, что LLM инициализирована.',
    formatFailedLlmUnavailable: 'Ошибка форматирования. LLM может быть недоступна.',
    deleteSongConfirm: 'Вы уверены, что хотите удалить «{title}»? Это действие необратимо.',
    ...
    videoRenderFailed: 'Ошибка рендеринга видео. Попробуйте ещё раз.',

    // SongList / Filters
    searchYourSongs: 'Поиск по вашим трекам...',
    filters: 'Фильтры',
    ...
    selectSongToView: 'Выберите трек для просмотра деталей',
    noSongsMatchFilters: 'Треки по заданным фильтрам не найдены.',
    clearFilters: 'Сбросить фильтры',

    // RightSidebar - Song Details
    songDetails: 'Детали трека',
    created: 'Создан',
    ...
    // Repaint mode
    repaintMode: 'Перерисовка',
    coverMode: 'Кавер',
    repaintModeDescription: 'Перегенерировать временной отрезок, сохранив остальное',
    coverModeDescription: 'Преобразовать существующий трек в новом стиле',
    repaintStart: 'Начало (с)',
    repaintEnd: 'Конец (с)',
    repaintStartPlaceholder: '0',
    repaintEndPlaceholder: 'конец трека',
    sftModelRequired: 'Перерисовка требует модель SFT',
    sftModelDownloading: 'Загрузка модели SFT…',
    sftModelReady: 'Модель SFT готова',
    sftModelNotFound: 'Модель SFT не найдена — перейдите в раздел «Модели» для загрузки',
    sftModelSwitched: 'Переключено на модель SFT для перерисовки',
    autoSwitchedToSft: 'Автоматически переключено на модель SFT (требуется для перерисовки)',

    // Lego mode
    legoMode: 'Lego',
    legoModeDescription: 'Генерировать новую инструментальную дорожку поверх основного трека',
    legoTrackLabel: 'Инструментальная дорожка',
    legoTrackPlaceholder: 'Выберите инструмент…',
    legoBaseModelRequired: 'Режим Lego требует базовую модель (acestep-v15-base)',
    autoSwitchedToBase: 'Автоматически переключено на базовую модель (требуется для Lego)',

    // Understand
    understand: 'Анализ',
    understandTooltip: 'Анализировать аудио с помощью ИИ для извлечения описания, текста, BPM и другого',
    understandApply: 'Применить к форме',
    understandApplyCaption: 'Применить описание',
    understandApplyLyrics: 'Применить текст',
    understandResult: 'Результат анализа',
    understandRunning: 'Анализ аудио…',
    understandError: 'Ошибка анализа',
    understandNotAvailable: 'Бинарный файл ace-understand не найден',

    // Search Page
    searchSongsPlaceholder: 'Поиск треков, плейлистов, авторов или жанров',
    songsMatching: 'Треки по запросу',
    featuredSongs: 'Рекомендуемые треки',
    noSongsFound: 'Треки не найдены по запросу',
    creatorsMatching: 'Авторы по запросу',
    featuredCreators: 'Рекомендуемые авторы',
    noCreatorsFound: 'Авторы не найдены по запросу',
    noCreatorsYet: 'Авторов пока нет. Будьте первым, кто поделится музыкой!',
    playlistsMatching: 'Плейлисты по запросу',
    featuredPlaylists: 'Рекомендуемые плейлисты',
    noPlaylistsFound: 'Плейлисты не найдены по запросу',
    noPlaylistsYet: 'Публичных плейлистов пока нет. Создайте один и поделитесь любимым!',
    genres: 'Жанры',
    songs: 'треков',
    ...
    recent: 'Последние',
    top: 'Топ',
    noPublicSongsYet: 'Публичных треков пока нет',
    ...
    descriptionPlaceholder: 'Музыка для работы...',
    ...
    usernameMinLengthError: 'Имя пользователя должно содержать не менее 2 символов',
    usernameTakenError: 'Это имя пользователя уже занято',
    usernameUpdateFailedError: 'Не удалось обновить имя пользователя',
    usernameRequirements: 'Только буквы, цифры, нижние подчёркивания и дефисы',
    ...
    deleteSong: 'Удалить трек',
    useAsReference: 'Использовать как референс',
    coverSong: 'Сделать кавер',
    confirmDeleteTitle: 'Удалить трек',
    confirmDeleteManyTitle: 'Удалить треки',
    deleteSongsConfirm: 'Удалить {count} треков? Это действие необратимо.',
    songsDeletedSuccess: 'Треки успешно удалены',
    songsDeletedPartial: 'Удалено {succeeded}/{total} треков',
    deleteUploadConfirm: 'Удалить эту загрузку? Это действие необратимо.',
    cannotBeUndone: 'Это действие необратимо.',

    // Player
    nowPlaying: 'Сейчас играет',
    selectSongToPlay: 'Выберите трек для воспроизведения',
    ...
    // SongProfile
    loadingSong: 'Загрузка трека...',
    songNotFound: 'Трек не найден',
    similar: 'Похожие',
    by: 'от',
    ...
    emailSubject: 'Послушай этот ИИ-трек',
    emailBody: 'Привет!\n\nЯ создал этот ИИ-трек и думаю, тебе понравится:\n\n«{title}» от {creator}\n{style}\n\nСлушай здесь: {url}\n\nСделано с ACE-Step UI — бесплатный локальный ИИ-генератор музыки с открытым исходным кодом!',

    // Reference Modal
    referenceModalTitle: 'Референс',
    coverModalTitle: 'Кавер',
    referenceModalDescription: 'Создавайте треки по мотивам референсного трека',
    coverModalDescription: 'Преобразуйте существующий трек в новую версию',
    ...
    uploadAudioFilesAsReferences: 'Загрузите аудиофайлы, чтобы использовать их как референсы',
  },
  zh: {
    // Navigation
    create: '创作',
